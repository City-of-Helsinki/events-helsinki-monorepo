...
<p align="center">
  <a aria-label="Build" href="https://github.com/City-of-Helsinki/events-helsinki-monorepo/actions?query=workflow%3ACI">
    <img alt="build" src="https://img.shields.io/github/workflow/status/City-of-Helsinki/events-helsinki-monorepo/CI-nextjs-app/main?label=CI&logo=github&style=flat-quare&labelColor=000000" />
  </a>
  <a aria-label="Codefactor grade" href=https://www.codefactor.io/repository/github/City-of-Helsinki/events-helsinki-monorepo">
    <img alt="Codefactor" src="https://img.shields.io/codefactor/grade/github/City-of-Helsinki/events-helsinki-monorepo?label=Codefactor&logo=codefactor&style=flat-quare&labelColor=000000" />
  </a>
  <a aria-label="CodeClimate maintainability" href="https://codeclimate.com/github/City-of-Helsinki/events-helsinki-monorepo">
    <img alt="Maintainability" src="https://img.shields.io/codeclimate/maintainability/City-of-Helsinki/events-helsinki-monorepo?label=Maintainability&logo=code-climate&style=flat-quare&labelColor=000000" />
  </a>
  <a aria-label="CodeClimate technical debt" href="https://codeclimate.com/github/City-of-Helsinki/events-helsinki-monorepo">
    <img alt="Techdebt" src="https://img.shields.io/codeclimate/tech-debt/City-of-Helsinki/events-helsinki-monorepo?label=TechDebt&logo=code-climate&style=flat-quare&labelColor=000000" />
  </a>
