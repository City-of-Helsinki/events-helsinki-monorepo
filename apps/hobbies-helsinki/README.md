...
| keywordOrSet3     | []                                       | x            | -        | A list of keywords                                                                            |
...
| superEvent        | "none"                                   | -            | -        | Filter by a specific (super) event id or set to "none" for events without superevent.         |
| audienceMaxAgeGt  | ""                                       | x            | -        | Filter by audience age: "max age greater than". Used by the age selector.                     |
| audienceMinAgeLt  | ""                                       | x            | -        | Filter by audience age: "min age less than". Used by the age selector.                        |
| suitableFor       | ""                                       | ?            | -        | **WARNING: ** suitableFor is fixed to `"$audienceMinAgeLt, audienceMaxAgeGt"` \*              |

> \*) TODO: Use suitableFor or audienceMaxAgeGt & audienceMinAgeLt, but not both together.
...
4. `audienceMinAgeLt` and `audienceMaxAgeGt` are copied from the (related) event.
...
| ---------- | --------------------------------------------------- | ------------------------------------------------------------------------- |
| eventType  | ["Course"]                                          | Select only "general" type events                                         |
