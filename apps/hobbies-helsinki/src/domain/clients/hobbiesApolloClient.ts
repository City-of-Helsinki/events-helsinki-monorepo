...
export default function initializeHobbiesApolloClient(): ApolloClient<NormalizedCacheObject> {
...
export function useHobbiesApolloClient(): ApolloClient<NormalizedCacheObject> {
  // NOTE: Critical: The Apollo cache should never be cleared!
  // Carefully test the cache after any changes done here.
  return React.useMemo(() => initializeHobbiesApolloClient(), []);
}
