...
Basic demo nextjs nextjs-app, part of the [events-helsinki-monorepo](https://github.com/City-of-Helsinki/events-helsinki-monorepo).
...
- [Changelog](https://github.com/City-of-Helsinki/events-helsinki-nextjs-app/blob/main/apps/nextjs-app/CHANGELOG.md)

## Quick start

> For rest/api database access be sure to start `docker-compose up main-db`,
> see detailed instructions (seeding, docker, supabase...) in the [@events-helsinki/db-main-prisma README](https://github.com/City-of-Helsinki/events-helsinki-monorepo/blob/main/packages/db-main-prisma/README.md).
...
This app relies on packages in the monorepo, see detailed instructions in [README.md](https://github.com/City-of-Helsinki/events-helsinki-monorepo)

```json5
{
  dependencies: {
    "@events-helsinki/core-lib": "workspace:*",
...
```json5
{
  "compilerOptions": {
    ...
    "paths": {
      ...
      "@events-helsinki/core-lib/*": ["../../../packages/core-lib/src/*"],
      "@events-helsinki/core-lib": ["../../../packages/core-lib/src/index"],
