 ...
 * });
 */
export function useSelectedEventsQuery(
  baseOptions: Apollo.QueryHookOptions<
    SelectedEventsQuery,
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<SelectedEventsQuery, SelectedEventsQueryVariables>(
    SelectedEventsDocument,
    options
  );
}
export function useSelectedEventsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    SelectedEventsQuery,
    SelectedEventsQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<SelectedEventsQuery, SelectedEventsQueryVariables>(
    SelectedEventsDocument,
    options
  );
}
export type SelectedEventsQueryHookResult = ReturnType<
  typeof useSelectedEventsQuery
>;
export type SelectedEventsLazyQueryHookResult = ReturnType<
  typeof useSelectedEventsLazyQuery
>;
export type SelectedEventsQueryResult = Apollo.QueryResult<
  SelectedEventsQuery,
  SelectedEventsQueryVariables
>;
 ...
 * });
 */
export function useSelectedVenuesQuery(
  baseOptions: Apollo.QueryHookOptions<
    SelectedVenuesQuery,
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<SelectedVenuesQuery, SelectedVenuesQueryVariables>(
    SelectedVenuesDocument,
    options
  );
}
export function useSelectedVenuesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    SelectedVenuesQuery,
    SelectedVenuesQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<SelectedVenuesQuery, SelectedVenuesQueryVariables>(
    SelectedVenuesDocument,
    options
  );
}
export type SelectedVenuesQueryHookResult = ReturnType<
  typeof useSelectedVenuesQuery
>;
export type SelectedVenuesLazyQueryHookResult = ReturnType<
  typeof useSelectedVenuesLazyQuery
>;
export type SelectedVenuesQueryResult = Apollo.QueryResult<
  SelectedVenuesQuery,
  SelectedVenuesQueryVariables
>;
...
export function useUpcomingEventsQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<UpcomingEventsQuery, UpcomingEventsQueryVariables>(
...
export function useUpcomingEventsLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<UpcomingEventsQuery, UpcomingEventsQueryVariables>(
    UpcomingEventsDocument,
    options
  );
}
...
>;
export type UpcomingEventsQueryResult = Apollo.QueryResult<
  UpcomingEventsQuery,
  UpcomingEventsQueryVariables
>;
