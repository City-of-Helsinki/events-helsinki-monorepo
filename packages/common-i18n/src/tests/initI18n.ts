...
export const initializeI18nWithConfig = async () => {
  // Use the global i18n instance. If it's already initialized, just return it.
  // This prevents re-initialization warnings outside of tests.
  ...
  await i18n
    ...
    .init(config); // Initialize with your configuration

  return i18n; // Return the now-initialized global i18n instance
};

// Call the initialization
initializeI18nWithConfig();
