...
Basic demo of a shared package using [prisma](<(https://prisma.io)>) to handle database access, part of the [events-helsinki-monorepo](https://github.com/City-of-Helsinki/events-helsinki-monorepo)
